...
class SshConfig(Model):
    ...
    fields = {
        ...
        'agent_forwarding': Field(bool, False, None),
    ...
    def __setattr__(self, name, value):
        ...
        patch_method = getattr(self, 'patch_' + name, None)
        if patch_method:
    ...
    patch_agent_forwarding = transform_bool
    patch_use_mosh = transform_bool
...
class Group(SshConfigMixin, Model):
    ...
    fields = {
        ...
        'credentials_mode': Field(str, False, None),
    }
    set_name = 'group_set'
    crypto_fields = {'label', }
